...
generate walk0 = 1 if (station_km >= 1.2 & station_km <2)

recode walk1 walk2 walk3 walk4 walk5 walk6 walk0 (.=0)

reghdfe lnprice walk1 walk2 walk3 walk4 walk5 walk6 walk0 detached_dum semi_d_dum terrace_dum freehold newbuild thamesriv_dist dist_to_cbd bus_distnear grossannualpay jobdensity hoursworked unemployment if station_km<=1, absorb(year msoa11) vce(robust)
outreg2 using mycat.doc, replace ctitle ("MSOA control")
reghdfe lnprice walk1 walk2 walk3 walk4 walk5 walk6 walk0 detached_dum semi_d_dum terrace_dum freehold newbuild thamesriv_dist dist_to_cbd bus_distnear grossannualpay jobdensity hoursworked unemployment if station_km<=1, absorb(year lsoacode) vce(robust)
